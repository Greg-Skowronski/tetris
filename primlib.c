...
/*static Uint32 colors[COLOR_MAX] = {0x000000ff, 
                               0xff0066cc, 0x00ff00ff, 0x0000ffff,
                               0xff006699, 0xff00ffff, 0xffff00ff,
                               0xffffffff};*/

static Uint32 colors[COLOR_MAX] = {0x000000FF, 
                               0xff0000ff, 0x00ffffCC, 0x0000ffff,
                               0xDD6600CC, 0xff00ffff, 0x00DDFFCC,
                               0xffffffff};
...
int initGraph()
{
	...
	if ( (screen=SDL_SetVideoMode(700,700,video_bpp,videoflags)) == NULL ) {
